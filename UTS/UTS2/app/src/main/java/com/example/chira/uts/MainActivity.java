...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pil = new String[] {"greentea", "nutella", "oreo", "ovomaltine"};
        Gbr = new String[] {
                Integer.toString(R.drawable.greentea),
                Integer.toString(R.drawable.nutella),
                Integer.toString(R.drawable.oreo),
                Integer.toString(R.drawable.ovomaltine),};
